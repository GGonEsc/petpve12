function [src,cls,mask,TSEG,SLAB,opt] = SSGC(src,cls,res,opt)%GCBM
...
% University Jena
% $Id: SSGC.m 423 2011-07-07 12:15:48Z gaser $
...
% align other voxels and smooth the map (median filter)
  ...
  clear S; opt.time.GBM8GBM = dp('SSGC',opt,stime); stime = clock;
